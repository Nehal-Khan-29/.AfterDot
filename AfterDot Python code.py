...
def aboutpage():
    ...
    Label(about,text=('''This program is created on 25 March 2023 by Nehal Khan and supported by Sridharan, Athish Vishnu.'''),font=('Arial',15),bg='white').place(x=250,y=200)
